# Generated by Django 5.1.4 on 2026-05-05 02:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='CareerIntelligenceReport',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('report_type', models.CharField(choices=[('career_path', 'Career Path Predictor'), ('skill_gap', 'Skill Gap Analyzer'), ('market_trends', 'Market Trends'), ('resume_gap', 'Resume vs Job Gap'), ('competitor', 'Competitor Analysis')], max_length=20)),
