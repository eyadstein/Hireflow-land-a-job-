...
# ── Recruiter Performance Analytics (Omar — #35) ──
...
class PerformanceSummaryView(APIView):
    ...
    def get(self, request):
        ...
        # Review rate: what percentage of applications have been reviewed
        review_rate = round((reviewed_count / total_apps) * 100) if total_apps > 0 else 0

        # Average response time: time between application created and reviewed
        ...
        # Efficiency score (0-100): combines review rate + speed
...
class ActivityLogView(APIView):
    ...
    def get(self, request):
        ...
        # Reviews per day (accepted + rejected)
        reviews_per_day = (
