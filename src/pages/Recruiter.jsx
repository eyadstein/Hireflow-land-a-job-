...
const quickLinks = [
  ...
  },
  {
    icon: UserSearch,
    label: "Candidates",
    desc: "Browse & profile candidates",
  ...
  },
  {
    icon: Wrench,
    label: "Optimize",
    desc: "Job posting optimization",
    path: "/recruiter/optimize",
    color: "text-cyan-500",
    bg: "bg-cyan-50",
  },
  {
  ...
  },
  {
    icon: Database,
    label: "CRM",
    desc: "Candidate relationship mgmt",
    path: "/recruiter/crm",
    color: "text-teal-500",
    bg: "bg-teal-50",
  },
  ...
  const createMutation = useMutation({
    ...
    onError: (err) => {
      const message =
        err?.message ||
        err?.detail ||
        "Failed to post job. Make sure you are logged in as a recruiter.";
    ...
    <div className="p-8 lg:p-12 w-full max-w-[1600px]">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-2">
          Manage your hiring pipeline end-to-end.
        </p>
      </div>
      ...
      <div>
        ...
        {showForm && (
          <div className="bg-card border border-border rounded-xl p-5 mb-5">
            ...
            {error && (
              <div className="px-4 py-3 rounded-xl bg-red-50 border border-red-200 text-red-700 text-sm mb-3">
                {error}
              </div>
            )}
